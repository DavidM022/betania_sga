...
import { getEstudiante, updateEstudiante, reset } from '../../../features/estudianteSlice';
...
const EditarEstudiante = () => {
    ...
    const { isLoading, isError, message } = useSelector((state) => state.estudiantes);
    ...
    return (
        <>
            <Stack spacing={4} direction="row" justifyContent="space-between" py={4}>
                ...
                <HStack spacing={4} direction="row">
                    <Text fontSize="lg" fontWeight={'bold'}>Modificar Estudiante Seleccionado</Text>
                </HStack>
            </Stack>
            ...
            <form onSubmit={handleUpdateSave}>
                ...
                <Stack spacing={4} direction="row" justifyContent="space-between" py={6}>
                    <Text fontSize="lg" fontWeight={'bold'}>Más Detalles del estudiante</Text>
