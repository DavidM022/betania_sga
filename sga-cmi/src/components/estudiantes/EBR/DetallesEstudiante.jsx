...
const DetallesEstudiante = ({ location }) => {
    ...
    const { estudiante, isLoading, isError, message } = useSelector((state) => state.estudiantes);
    ...
    return (
        <>
            <Stack spacing={4} direction="row" justifyContent="space-between" py={4}>
                ...
                <HStack spacing={4} direction="row">
                    <Text fontSize="lg" fontWeight={'bold'}>Detalles del Estudiante Seleccionado</Text>
                </HStack>
            </Stack>
            ...
            >
                ...
                >
                    ...
                    <Stack direction="column" p={6} spacing={4} w="full" bg="white" _dark={{ bg: "primary.1000" }}>
                        ...
                        <Divider />
                        <Stack spacing={4} direction={{ base: "column", lg: "row" }} justifyContent="space-between">
                            <Text fontWeight="bold" mr={2}>CI </Text>
            ...
            >
                <Stack justifyContent="center">
                    <Text fontSize={'xl'} fontWeight="bold" textAlign="center">MÁS DETALLES DEL ESTUDIANTE</Text>
                </Stack>
                <Divider />
                <Stack direction={{ base: "column", lg: "row" }} justifyContent="space-between">
            ...
            >
                <Stack justifyContent="center">
                    <Text fontWeight="bold" fontSize={'xl'} textAlign="center">DETALLES ACERCA DE SUS PADRES</Text>
                </Stack>
                <Divider />
                <Stack direction={{ base: "column", lg: "row" }} justifyContent="space-between">
