...
const ModalAgregarUniforme = ({ categorias }) => {
    ...
    const listaCategorias = categorias.filter(categoria => categoria.estado !== false)
                            ...
                            <Stack spacing={2} mt={-4} direction="column" justifyContent="space-between" p={2}>
                                ...
                                <Stack spacing={2} direction={{ base: 'column', lg: "row"}} justifyContent="stretch">
                                    <FormControl>
                                        ...
                                        <Input
                                            type="text"
                                            placeholder='https://images.cdn3.buscalibre.com/e86138aef74d9337ab3d571972b3a4ea.jpg'
