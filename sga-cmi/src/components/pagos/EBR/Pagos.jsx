...
import { getAllPagos, updateEstadoPago, reset } from '../../../features/pagos/EBR/pagoSlice';
...
const Pagos = () => {
    ...
    const { pagos, isLoading, isError, message, currentPage, totalRows } = useSelector((state) => state.pagos_ebr);
                ...
                <div>
                    ...
                    >
                        <Stack spacing={1} direction="row" align={'center'}>
                            ...
                            />
                            <Text noOfLines={1} fontSize="12px" color={'primary.100'} _hover={{ color: 'primary.200' }}>{row.estudiante?.apellidos + ' ' + row.estudiante?.nombres}</Text>
                        </Stack>
                    </Link>
                </div>
            )
