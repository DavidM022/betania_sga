...
const DetallesPago = ({ location }) => {
    ...
    return (
        <>
            <Stack spacing={4} direction="row" justifyContent="space-between" py={2}>
                ...
                <HStack spacing={4} direction="row">
                    <Text fontSize={{ base: "xs", lg: "lg" }} fontWeight={'bold'}>Detalles del Pago Seleccionado</Text>
                </HStack>
            </Stack>
            ...
            <Stack
                ...
                p={4}
            >
                <Stack direction="column" py={6} px={4} spacing={4} w="full" bg="white" _dark={{ bg: "primary.1000" }}>
                    <Text fontSize={{ base: "md", lg: "lg" }} fontWeight={'black'} textAlign={'center'}>DETALLES DEL PAGO</Text>
                    <Divider />
                    <Stack direction={{ base: "column", lg: "row" }} spacing={1} w="full" bg="white" _dark={{ bg: "primary.1000" }} justifyContent="space-between" textAlign={'center'}>
                    ...
                    <Divider />
                    <Stack direction={{ base: "column", lg: "row" }} spacing={1} w="full" bg="white" _dark={{ bg: "primary.1000" }} justifyContent="space-around" textAlign={'center'}>
                        <Stack spacing={0} direction="column" justifyContent="space-between">
