...
import { getEstudianteSearch } from '../../../features/estudiantes/RESIDENCIA/estudianteSlice';
...
const ModalRegistrarPago = () => {
    ...
    const conceptos = [
        { value: 'PAGOS DE INSCRIPCION', label: 'PAGOS DE INSCRIPCION' },
        { value: 'COLABORACIONES MENSUALES', label: 'COLABORACIONES MENSUALES' },
